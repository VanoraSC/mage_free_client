...
| 0085 | Robolectric out of the logic modules | 0082, 0083 | Seven of the nine Robolectric tests in `:core:cards`/`:core:decks` become plain JVM tests running in CI, which is what makes the portability claim check itself per commit. The other two test the Android edge itself and stay, as do the 5 Compose tests — they are the hermetic gate. |
