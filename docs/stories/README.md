...
| — | *Casting & interaction* | 0055, 0056 | Tap-select-confirm, floating controls + visibility toggle, targeting with confirm, mana, cascading cancel. To be specified next. |
