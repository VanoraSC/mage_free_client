...
/**
 * The `User-Agent` every card-art request carries.
 *
 ...
 *
 * **A `User-Agent` alone is not sufficient.**
...
internal object CardArtUserAgent {
     ...
     *
     * This takes the version rather than reading it: deriving it from `PackageManager`
