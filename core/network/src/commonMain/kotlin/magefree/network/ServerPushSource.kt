 ...
 * and a session-lifecycle frame becomes a `SessionEvent`, a server *push* that is neither — a table
 ...
 * `:protocol`-free (the discipline); this hook is consumed only inside `:core:network` (the DI
