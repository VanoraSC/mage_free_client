 ...
 * (`cardName`, `setCode`, `cardNumber`, `amount`). This is the shared representation that story 0034
 * (import/export) and Epic 7 (submit-to-table) consume, so all three agree on deck identity by
