 ...
 * `cards.sqlite` through (story 0082). `formats.json` and the card catalog differ only in size, so
 * they share one mechanism rather than each carrying its own (story 0083).
 */
