...
/**
 * **The one place that decides *when* the app answers a priority prompt**.
 *
 ...
 * That is a design constraint here:
 *
 ...
 * whether mana is floating — and returns [PassDecision.PassImmediately]
...
/**
 * The policy this release ships: **everything explicit and manual**. The player is asked every
