...
/**
 * Koin wiring for `:feature:connect` (story 0081). The feature had no Hilt module — its two
 ...
 * **first** screen the app shows (story 0047's entry policy starts on `ConnectRoute`), a miss here
